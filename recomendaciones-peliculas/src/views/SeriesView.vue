<template>
  <div class="container">
    ...
    <SearchBar @search="handleSearch" placeholder="Buscar series..." />
...
export default {
  ...
  setup() {
    ...
    const cargarSeries = async () => {
      ...
      try {
        const response = await getPopulares('tv', pagina.value)
    ...
    onMounted(cargarSeries)
    watch(pagina, cargarSeries)
